...
def Li12Si7(data_path):
    ...
    return {
        ...
        "score": 0.993099,
        "mossbauer_contributions": np.array(
            [
                0.75,
                0.75,
                0.75,
...
def Li13Si4(data_path):
    ...
    return {
        ...
        "score": 0.991874,
        "mossbauer_contributions": np.array(
            [0.63, 0.39, 0.39, 0.63, 0.39, 0.63, 0.63, 0.39]
        ),
    }
...
@pytest.fixture()
def gofr(data_path, Li12Si7, Li7Si3, Li13Si4, Li15Si4):
    df = pd.read_csv(str(data_path / "gofr.csv"))
    return {
        "universes": [Li12Si7["u"], Li7Si3["u"], Li13Si4["u"], Li15Si4["u"]],
        "pdf": df,
        "weights": np.array([0.296355, 0.0, 0.053113, 0.119111]),
        "offset": -0.372972,
        "pred": np.array(
            [
                -0.38425145,
